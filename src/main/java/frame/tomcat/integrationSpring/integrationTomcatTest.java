package frame.tomcat.integrationSpring;

import frame.tomcat.embeddedTomcat.HelloServlet;
...
@Slf4j
public class integrationTomcatTest {
...
//            servletContext.addServlet("dispatcherServlet", dispatcherServlet).addMapping("/");
            ...
            for (ServletRegistrationBean registrationBean : springContext.getBeansOfType(ServletRegistrationBean.class).values()) {
                System.out.println("registrationBean " + registrationBean);
